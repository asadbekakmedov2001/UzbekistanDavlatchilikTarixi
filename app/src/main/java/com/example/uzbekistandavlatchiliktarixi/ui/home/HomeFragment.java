...
public class HomeFragment extends Fragment implements UserAdapter.SelectedUser {
    ...
    private void initial() {
        ...
        modelRcyclers.add(new ModelRcycler(R.drawable.fan_das,"ISHCHI O'QUV DASTUR","5120300 - Tarix (mamlakatlar va mintaqalar bo’yicha) yo’nalishi 3-kurs uchun","https://github.com/asadbekakmedov2001/UzbekistanDavlatchilikTarixi/raw/main/app/src/main/assets/fan_dastur.pdf"));
