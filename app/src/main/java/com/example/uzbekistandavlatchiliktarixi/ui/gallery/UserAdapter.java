...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.UserAdapterViewHolder> implements Filterable {
    ...
    private List<com.example.uzbekistandavlatchiliktarixi.ui.gallery.ModelRcycler> userModelListFilter;
    private Context context;
    private com.example.uzbekistandavlatchiliktarixi.ui.gallery.UserAdapter.SelectedUser selectedUser;

    public UserAdapter(List<com.example.uzbekistandavlatchiliktarixi.ui.gallery.ModelRcycler> userModelList, GalleryFragment selectedUser) {
    ...
    public UserAdapter.UserAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UserAdapter.UserAdapterViewHolder(LayoutInflater.from(context).inflate(R.layout.item_recycler,null));
    }
